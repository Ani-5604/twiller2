import {
  html_parse_stringify_module_default
} from "./chunk-QN64NKQ5.js";
import {
  require_react
...
var renderNodes = (children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
  ...
  const pushTranslatedJSX = (child, inner, mem, i, isVoid) => {
    if (child.dummy) {
      ...
      mem.push(...import_react.Children.map([child], (c) => {
        const props = {
          ...c.props
        };
...
function Trans({
  ...
  if (components) {
    Object.keys(components).forEach((c) => {
      if (!components[c].key) components[c] = (0, import_react.cloneElement)(components[c], {
        key: c
      });
